...
*informa��o nescessaria para realizar a busca
*na funcao buscaABM()
*/
...
/**
*Recebe o n� que contem o valor e reordena os
*valores apartir da posi��o
*/
    ...
    if((*n) == NULL) {
        ...
        if(valor == (*n)->chaves[aux].info) {
            ...
            if((*n)->chaves[0].ramoMenor == NULL && (*n)->chaves[1].ramoMenor == NULL && (*n)->chaves[2].ramoMenor == NULL && (*n)->maior == NULL){
                ...
                ///Se a chave estiver em qualquer outro N� N�o Follha
                if(aux < ((*n)->tamanho-1))
...
/**
*TODO Fazer uma fun��o que Destrua
*a arvore ABM
*/
